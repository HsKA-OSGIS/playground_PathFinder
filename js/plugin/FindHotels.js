BR.FindHotels = L.Control.extend({
    ...
    statics: {
        MSG_DISABLED: 'Click on route to get hotels',
        MSG_ENABLED: 'Click to get nearby hotels',
        MSG_CANCEL: 'Click to remove hotels',
        MSG_EDIT:
    ...
    onAdd: function (map) {
        ...
        this.removeHotels = function (control) {
            ...
            states: [
                {
                    ...
                    icon: 'fa-bed active',
                    title: BR.FindHotels.MSG_BUTTON,
                    onClick: this.startDrawing,
                },
                {
                    stateName: BR.FindHotels.STATE_ENABLED,
                    icon: 'fa-ban active',
                    title: BR.FindHotels.MSG_BUTTON_CANCEL,
                    onClick: this.stopDrawing,
                },
                {
                    stateName: BR.FindHotels.STATE_DELETE,
                    icon: 'fa-trash active',
                    title: BR.FindHotels.STATE_DELETE,
                    onClick: this.removeHotels,
                },
            ],
        });

        console.log(this.button, 'fffff');
...
BR.EditingTooltip = L.Handler.extend({
    ...
    _bind: function (e) {
        ...
        var layer = e.layer;
        layer.bindTooltip(BR.FindHotels.MSG_DISABLED, {
            direction: 'bottom',
    ...
    _addCreate: function (e) {
        ...
        tooltip.setTooltipContent(BR.FindHotels.MSG_CREATE);
    ...
    _enable: function (e) {
        e.layer.setTooltipContent(BR.FindHotels.MSG_ENABLED);
    ...
    _disable: function (e) {
        e.layer.setTooltipContent(BR.FindHotels.MSG_DISABLED);
        this._setCloseTimeout(e.layer);
    },
});
