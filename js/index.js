...
(function () {
    ...
    function initApp(mapContext) {
        ...
        BR.FindHotels.MSG_DISABLED = i18next.t('map.hotels.disabled');
        BR.FindHotels.MSG_ENABLED = i18next.t('map.hotels.enabled');
        BR.FindHotels.MSG_BUTTON_CANCEL = i18next.t('map.hotels.cancel');
        BR.FindHotels.MSG_HELP = i18next.t('map.hotels.help');
        hotels = new BR.FindHotels();
        // nogos.on('update', updateRoute);
